                ...
                <div class="container">
                    ...
                    <div class="pag-mensajeContenido" >
                        ...
                        <form class="tablamensajetexto" method="post" action="/crearMensajeSV">
                            ...
                            <div class="partes" >
                                <input type="submit" tabindex="10" id="enviarmensajebotton" style="margin-left: 3em" value="Enviar" >
                                <input type="button" tabindex="10" id="volverbuzonbotton" style="margin-left: 22em" onclick="window.location.href='buzon.html'"   value="Volver al buzón">
                            </div>
                        </form>
