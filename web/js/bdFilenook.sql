...
CREATE TABLE Mensaje(
	--idMensaje INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
        idMensaje INTEGER,
...
CREATE TABLE Nook(
	--idNook INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
        idNook INTEGER,
	nombre VARCHAR(50),
	resumen VARCHAR(180),
	autor VARCHAR(10),
...
CREATE TABLE ValoracionesNook(
	...
	puntuacion INTEGER,
	fecha DATE,
	PRIMARY KEY (nook, usuario, fecha),
...
CREATE TABLE Comentario(
	--idComentario INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
CREATE TABLE ValoracionComentario(
	...
	fecha DATE,
	usuario VARCHAR(10),
	PRIMARY KEY (comentario, fecha, usuario),
...
INSERT INTO Mensaje VALUES (0,'Me gustaria que me explicase la función de la lía 127 de su código, gracias.','2019-04-09',1,'Enviado','patagua','rafhige');
INSERT INTO Mensaje VALUES (1,'Me gustaria que me explicase la función de la lía 127 de su código, gracias.','2019-04-09',0,'Recibido','rafhige','patagua');

INSERT INTO Nook VALUES (0,'MIPS','Prácticas en lenguaje ensamblador de primero de carrera de Ingeniería Informática','rafhige','2016-06-20','2016-06-21',25);
INSERT INTO Nook VALUES (1,'Códigos Reed-Solomon','Ejercicios de la asignatura de Criptografía','patagua','2018-12-20','2018-12-20',10);
...
INSERT INTO Comentario VALUES (0,'2017-08-06','sanblas','Buen nook!!');
INSERT INTO Comentario VALUES (1,'2016-11-13','andcabe','Tengo una duda con el archivo Sumador.s te mando un correo.');
